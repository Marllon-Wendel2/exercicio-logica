...
class Atleta {
    ...
    constructor(nome, primeiroSalto, segundoSalto, terceiroSalto, quartoSalto, quintoSalto) {
        this.nome = nome;
        this.primeiroSalto = primeiroSalto;
        this.segundoSalto = segundoSalto;
        this.terceiroSalto = terceiroSalto;
        this.quartoSalto = quartoSalto;
        this.quintoSalto = quintoSalto;
    }
}


cliPromise.question("Qual nome do candidato? ", (nome) => {
    cliPromise.question("Primeiro salto: ", (primeiroSalto) => {
        cliPromise.question("Segundo salto: ", (segundoSalto) => {
